...
- Codex skill files carry no tool-restriction frontmatter (unlike Claude's `allowed-tools`
  or Copilot's `tools:`): VS Code's Codex extension does not support one. Read-only
